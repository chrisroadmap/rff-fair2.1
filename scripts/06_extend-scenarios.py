...
for scenario in tqdm(range(1, RFF_SCENS + 1), desc="Making scenarios"):
    ...
    emissions_1750_2100 = np.divide(
        natural_emissions_1750,
        emissions_2100_2300_out[0, :],
        out=np.zeros_like(natural_emissions_1750),
        where=emissions_2100_2300_out[0, :] != 0,
    )
    ...
    for ispec in range(53):
        ...
        fossil_fraction[151:, ispec] = (
            emissions_1750_2100[ispec] * fossil_fraction[0, ispec]
        )
